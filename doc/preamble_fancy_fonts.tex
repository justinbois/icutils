...
% See documentation for mathspec on how these are set
% If you do not have Equity of Concourse fonts, comment out below
\usepackage{mathspec}
\setmainfont{Equity Text A}
\setallsansfonts[Scale=MatchLowercase]{Concourse T3}
\setallmonofonts[Scale=MatchLowercase]{Source Code Pro}
\setmathsfont(Digits,Latin)[Scale=MatchLowercase]{Equity Text A}
\setmathsfont(Greek)[Scale=MatchLowercase]{STIXGeneral}
\setmathrm{Equity Text A}
\exchangeforms{phi}
\setminwhitespace[2250]
...
\newfontfamily\subsectionfont{Concourse C3}
\newfontfamily\subsubsectionfont{Concourse C3}
